...
const Navbar = () => {
	...
	return (
		...
		>
			<div className="flex justify-between rounded-2xl items-center w-full h-full px-2 2xl:px-16">
				<Link href="/">
					<Image
						src="/../public/assets/sw.png"
						alt="/"
						width="80"
						height="80"
					/>
			...
			>
				...
				>
					...
					<div className="py-4 flex flex-col">
						...
						<div className="pt-40">
							<p className="uppercase tracking-widest text-[#ffbd59]">
								Let's Connect
							</p>
